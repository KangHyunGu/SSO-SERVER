<template>
  <MyDialog
    ...
    <q-form @submit="save">
      <q-card-section>
        <q-input label="AppName" v-model="form.appName"></q-input>
        <q-input label="Site Domain" v-model="form.siteUrl"></q-input>
        <q-select label="Allow" v-model="form.allowed" :options="allowOptions"></q-select>
      </q-card-section>
      <q-card-actions>
        <q-btn
          type="submit"
